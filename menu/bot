...
echo -e ""
case $opt in
1) clear ; apt update && apt install wget -y && wget https://raw.githubusercontent.com/Jengkoltunnel/xolpanel/main/xolpanel.sh && chmod +x xolpanel.sh && ./xolpanel.sh ; exit ;;
